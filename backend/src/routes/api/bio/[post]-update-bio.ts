...
router.post("/update/:id", ownerMiddleware, async (req, res) => {
    ...
    const schema = z.object({
        ...
        profileImageLayout: z.string().optional(),
        heroTransition: z.boolean().optional(),
        navTabColor: z.string().optional(),
        navTabTextColor: z.string().optional(),
        profileImageSize: z.string().optional(),
    ...
    const updateOptions: UpdateBioOptions = {
        ...
        buttonRadius: schema.buttonRadius,
        buttonShadow: schema.buttonShadow,
        buttonColor: schema.buttonColor,
        buttonTextColor: schema.buttonTextColor,
        bgSettings: {
            ...
            profileImageLayout: schema.profileImageLayout,
            heroTransition: schema.heroTransition,
            navTabColor: schema.navTabColor,
            navTabTextColor: schema.navTabTextColor,
            profileImageSize: schema.profileImageSize,
