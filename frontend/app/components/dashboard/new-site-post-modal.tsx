import {
    ...
    Settings, Plus, Sparkles, Info, Calendar, Check
} from "lucide-react";
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4" onClick={onClose}>
            ...
            >
                ...
                <div className="p-6 pb-4 border-b-2 border-black">
                    ...
                    {error && (
                        <div className="mb-4 p-3 bg-red-100 border-2 border-black text-red-600 rounded-xl text-sm font-bold shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                            {error}
                        </div>
                    )}
                    ...
                    <div className="flex gap-4 mb-6">
                        <label className={`flex items-center gap-2 cursor-pointer p-2 rounded-lg border-2 transition-all ${activeLanguage === "en" ? "border-black bg-[#C6F035] shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]" : "border-gray-200 bg-white"}`}>
                            <input
                                type="radio"
                                name="language"
                                value="en"
                                ...
                                className="hidden"
                            />
                            <span className="text-sm font-black px-2">🇺🇸 English</span>
                        </label>
                        <label className={`flex items-center gap-2 cursor-pointer p-2 rounded-lg border-2 transition-all ${activeLanguage === "pt" ? "border-black bg-[#C6F035] shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]" : "border-gray-200 bg-white"}`}>
                            <input
                                type="radio"
                                name="language"
                                value="pt"
                                ...
                                className="hidden"
                            />
                            <span className="text-sm font-black px-2">🇧🇷 Portuguese</span>
                        </label>
                    </div>
