  ...
  return (
    <div className="fixed left-1/2 bottom-6 z-50 w-full max-w-[520px] -translate-x-1/2 px-4 transition-all duration-500 ease-out animate-in slide-in-from-bottom-4 fade-in">
      <div className="w-full relative group mx-auto">
        ...
        <div className="relative flex items-center bg-surface-card rounded-full p-2 shadow-2xl shadow-black/50 border border-border transition-shadow duration-300 hover:border-border-hover">
          <div className="flex items-center h-12 pl-3 md:pl-4">
            <span className="text-xl md:text-2xl font-bold text-foreground select-none tracking-tight">portyo.me/p/</span>
          </div>
          <div className="flex-1 flex items-center justify-start relative h-12">
            <input
              ...
              className="w-full bg-transparent border-none outline-none text-xl md:text-2xl font-bold text-foreground placeholder:text-muted-foreground h-full text-left pl-0.5 tracking-tight"
              spellCheck={false}
            />
          </div>
          <button
            ...
            className="bg-primary hover:bg-primary-hover text-background font-bold text-base md:text-lg py-3 px-7 md:px-9 rounded-full transition-all duration-300 shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5 active:translate-y-0 shrink-0 disabled:opacity-50 disabled:pointer-events-none"
          >
