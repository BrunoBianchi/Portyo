        ...
        <>
                    ...
                    <div className="bg-white w-full max-w-[480px] rounded-xl p-6 relative z-10 shadow-2xl">
                        <div className="flex items-start justify-between mb-6">
                            <div>
                                ...
                                <h2 className="text-2xl font-bold text-foreground tracking-tight">Claim your link</h2>
                                <p className="text-muted-foreground mt-1 text-sm">Choose a unique username for your new page.</p>
                            </div>
                            <button onClick={() => setIsCreateModalOpen(false)} className="p-2 hover:bg-muted rounded-lg transition-colors text-muted-foreground hover:text-foreground" aria-label="Close modal">
                                <X className="w-5 h-5" />
                            </button>
                        </div>
                                ...
                                <div className="flex items-center bg-surface-card rounded-full h-16 px-6 border border-border shadow-sm focus-within:border-primary focus-within:ring-4 focus-within:ring-primary/10 transition-all duration-300 hover:shadow-md">
                                    ...
                                    <div className="flex-1 flex items-center h-full relative">
                                        <input
                                            ...
                                            className="flex-1 bg-transparent border-none outline-none text-xl md:text-2xl font-bold text-foreground placeholder:text-muted-foreground h-full text-right pr-0.5 tracking-tight w-full min-w-0"
                                            autoFocus
                                            spellCheck={false}
                                        />
                                        <span className="text-xl md:text-2xl font-bold text-muted-foreground select-none tracking-tight shrink-0">.portyo.me</span>
                                    </div>
            ...
            `}>
                ...
                <div className="p-4 pb-2 flex items-center justify-between">
                    ...
                    <button onClick={onClose} className="md:hidden text-muted-foreground hover:text-foreground p-2 hover:bg-muted rounded-lg transition-colors" aria-label="Close sidebar">
                        <X className="w-5 h-5" />
                    </button>
                </div>
                        ...
                        >
                            <div className="flex items-center gap-3 overflow-hidden flex-1 min-w-0">
                                ...
                                <div className="flex flex-col items-start overflow-hidden min-w-0 flex-1">
                                    <span className="text-[10px] uppercase tracking-wider text-muted-foreground font-bold mb-0.5">Current Page</span>
                ...
                <nav className="flex-1 px-3 space-y-1 overflow-y-auto py-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
                    ...
                    {bio ? (
                        navItems.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {isLocked && (
                                        <span
                                            className="px-1 py-0.5 text-[8px] md:text-[8px] font-bold rounded-full uppercase tracking-[0.08em] bg-gradient-to-r from-emerald-400 via-emerald-600 to-black text-white shadow-sm shadow-emerald-500/40 border border-emerald-900/60"
                                        >
                                            {badgeText}
                                        </span>
                                    )}
                        ...
                        <div className="px-3 py-4 text-center">
                            <p className="text-sm text-muted-foreground mb-3">Select or create a page to access the menu.</p>
                            <button
                                onClick={() => {
                                    if (canCreateBio) {
                                        setIsCreateModalOpen(true);
                            ...
                            >
                                <div className="flex items-center gap-3 min-w-0">
                                    ...
                                    <div className="flex flex-col min-w-0">
                                        <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Live Page</span>
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2">
                                <p className="text-sm font-bold truncate text-foreground">{user?.fullname || "User"}</p>
