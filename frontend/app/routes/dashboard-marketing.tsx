...
export default function DashboardMarketing() {
    ...
    const handleCreate = async (e: React.FormEvent) => {
        ...
        if (!isStripeConnected) {
            setCreateError(t("dashboard.marketing.errors.connectStripe"));
            return;
        }
        ...
        try {
            ...
            setCreateError(error.response?.data?.message || t("dashboard.marketing.errors.createSlot"));
        } finally {
            setIsCreating(false);
        }
    };
    ...
    const handleDelete = async () => {
        ...
        if (deletingSlot.status !== 'available') {
            alert(t("dashboard.marketing.errors.deleteInProgress"));
        ...
        try {
            ...
            alert(error.response?.data?.message || t("dashboard.marketing.errors.deleteSlot"));
        } finally {
            setIsDeleting(false);
        }
    };
    ...
    const handleAcceptProposal = async (proposalId: string) => {
        if (!confirm(t("dashboard.marketing.confirm.acceptProposal"))) return;

        if (!isStripeConnected) {
            alert(t("dashboard.marketing.errors.connectStripe"));
            return;
        }
        ...
        try {
            ...
            alert(t("dashboard.marketing.errors.acceptProposal"));
        } finally {
    ...
    const handleRejectProposal = async (proposalId: string) => {
        if (!confirm(t("dashboard.marketing.confirm.rejectProposal"))) return;
        setProcessingProposalId(proposalId);
        try {
            ...
            alert(t("dashboard.marketing.errors.rejectProposal"));
        } finally {
            setProcessingProposalId(null);
        }
    };
        ...
        <AuthorizationGuard>
            <div className="p-6 max-w-7xl mx-auto">
                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6" data-tour="marketing-grid">
