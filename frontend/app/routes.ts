...
const baseRoutes: RouteConfig = [
    ...
    { path: '/themes', file: "routes/dashboard-themes.tsx" },
    {
        ...
        children: [
            ...
            { path: "instagram/auto-reply", file: "routes/dashboard-instagram-auto-reply.tsx" },
            { path: "instagram/post-ideas", file: "routes/dashboard-instagram-post-ideas.tsx" },
            { path: "instagram/analytics", file: "routes/dashboard-instagram-analytics.tsx" },
