...
- Dynamic XML generated by frontend route
- No static file in `/public`
...
- `sitemap.xml` is dynamic (served by frontend route)
- `sitemap-index.xml` remains static in `/public`
