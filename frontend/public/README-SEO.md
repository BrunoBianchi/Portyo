...
| `sitemap.xml` | Dynamic sitemap generated by frontend route | Required |
...
`/sitemap.xml` is served dynamically by the frontend route.
...
Generated dynamically by the frontend route at `/sitemap.xml`.
...
**Note:** This sitemap no longer depends on a static file in `/public` and does not require manual regeneration.
